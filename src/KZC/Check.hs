...
-- four type indices
checkST :: Type -> Ti b (Type, Type, Type, Type)
checkST tau =
    compress tau >>= go
  where
...
-- three type indices
checkSTCUnit :: Type -> Ti b (Type, Type, Type)
checkSTCUnit tau =
    compress tau >>= go
  where
